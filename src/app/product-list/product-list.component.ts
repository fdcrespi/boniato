...
export class ProductListComponent implements OnInit {
  ...
  products: Product[] = [
    ...
    },
    {
      ...
      price: 180,
      stock: 9,
      description: "Loco de remate, de bodega Sánchez Potenzoni. Desde Luján de Cuyo con este exquisito Malbec",
      clearance: false,
      quantity: 0,
    ...
    },
    {
      ...
      price: 210,
      stock: 24,
      description: "Ruta 60, de Finca Don Diego nos ofrece desde Catamarca un Syrah perfecto para maridar con las pastas de Boniato",
      clearance: false,
      quantity: 0,
